	...
	<div class="container">
		<div class="row">
			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
 			...
 			<div class="writeButton" style="margin-bottom: 5px;margin-left:970px">
            <input type="submit" value="글쓰기"  onclick="location.href='./write.jsp'" style="width:90px; align-items: center; color:#ffffff; font-size:16px; background-color: #5f0080; border:none; border-radius: 3px; height:30px">
        </div>
		</form>
		</div>
	</div>
