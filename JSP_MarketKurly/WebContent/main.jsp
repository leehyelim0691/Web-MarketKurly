...
<%
    ...
    <div class="main">
        <div class="slider">
            <img class="sliderImage" src="./image/sliderimg1.png">
            <img class="sliderImage" src="./image/sliderimg2.png"> 
            <img class="sliderImage" src="./image/sliderimg3.png">
            <img class="sliderImage" src="./image/sliderimg4.png">  
        </div>
         <br><br>
        <div class="recommend">
            ...
            <div class="wrapper_r" style= "text-align:center; margin-left: 200px;"> 
                <ul class="sliderList">
                    <div class="sliderProduct1"  style="width:20%; height:20px; border:1px; float:left; margin-right:5px;">
                        <!-- <img id=product1  class="slide_img" src="./image/cucumber.png" style="width: 100%;"> -->
                        <img class=product1  src="./image/cucumber.png" style="width: 100%;">
                        <div style="text-align: left;" class="text">[조선호텔김치] 오이소박이</div>
                        <div style="color:darkred; text-align:left; float:left; font-weight: bold;">20%</div>
                        <div style="float:left; margin-left: 5px; font-weight: bold;"> 21,520원</div>          
                    </div>
                    <div class="sliderProduct2" id=product2 style="width:20%; height:20px; border:1px; float:left; margin-right:5px;">
                        <img class="product2" src="./image/eggplant.png" style="width: 100%;" >
                        <div style="text-align: left;" class="text">친환경 가지 2입</div>
                        <div style="color:darkred; text-align:left; float:left;font-weight: bold;">14%</div>
                        <div style="float:left; margin-left: 5px;font-weight: bold;"> 2,571원</div> 
                    </div>
                    <div class="sliderProduct3" id=product3 style="width:20%; height:20px; border:1px; float:left; margin-right:5px;">
                        <img class="product3" src="./image/snack.png"  style="width: 100%;">
                        <div style="text-align: left;" class="text">[오뗄두스] 구움과자 2종</div>    
                        <div style="text-align: left; float:left; margin-left: 5px;font-weight: bold;"> 2,000원</div> 
                    </div>
                    <div class="sliderProduct4" id=product4 style="width:20%; height:20px; border:1px; float:left; margin-right:5px;">
                        <img class="product4" src="./image/duck.png" style="width: 100%;" >
                        <div style="text-align: left;" class="text">[우리땅오리] 무항생제 오리 가슴살 슬라이스</div>
                        <div style="color:darkred; text-align:left; float:left;font-weight: bold;">20%</div>
                        <div style="float:left; margin-left: 5px;font-weight: bold;"> 5,520원</div> 
                    </div>
                </ul>
            </div>
        </div>
